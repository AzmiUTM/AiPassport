...
{{--                        <input class="form-control" placeholder="{{ __('Search') }}" type="text">--}}
                           <span class="mb-0 font-weight-bold" style="color:white">Academic Session : </span>
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                                <img alt="Image placeholder" src="{{ asset('argon') }}/img/theme/team-4.jpg">--}}
                                <img alt="Image placeholder" src="{{ asset('argon') }}/img/theme/avatar-1.jpg">
                            </span>
                            <div class="media-body ml-2 d-none d-lg-block">
                                <span class="mb-0 text-sm  font-weight-bold">{{ auth()->user()->ppv_username }}</span>
                            </div>
                        </div>
                    </a>
